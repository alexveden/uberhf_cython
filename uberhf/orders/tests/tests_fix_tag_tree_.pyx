...
class CyTagTreeTestCase(unittest.TestCase):
    ...
    def test_check_get_offset_all_duplicates(self):
        ...
        assert binary_tree_set_offset(tree, 1, 10) == 0
        assert binary_tree_set_offset(tree, 3, 30) == 1
        assert binary_tree_set_offset(tree, 5, 50) == 2
        ...
        assert binary_tree_get_offset(tree, 1) == USHRT_MAX-2
        assert binary_tree_get_offset(tree, 3) == USHRT_MAX-2
        assert binary_tree_get_offset(tree, 5) == USHRT_MAX-2
